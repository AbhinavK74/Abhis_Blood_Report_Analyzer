...
if st.session_state.report_data:
    ...
    with c2:
        st.markdown(f'<div class="metric-card"><h5>Attention Alerts 🚨</h5><h2>{total_anomalies}</h2><p style="color:#DC2626; font-size:12px; font-weight:700;">{high_flags} High | {low_flags} Low</p></div>', unsafe_allow_html=True)
    with c3:
